...
mod module_tests {
    ...
    fn test_modules_success() {
        ...
        let cpu_module = Module::new("CPU", "Intel i5-10210U (8) @ 4.200GHz")
            .with_width(45);
        
        let memory_module = Module::new("MEM", "8.2GB / 15.9GB (51%)")
            .with_width(45);
        
        let test_destination = "tests/modules_test_inacc.txt";
        
        // clear previous content and write header
        fs::write(test_destination, "This information is NOT accurate. It uses hardcoded values.\n\n").unwrap();
